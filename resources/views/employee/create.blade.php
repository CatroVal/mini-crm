            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('employee.save') }}">
                        ...
                        <div class="form-group row">
                            <label for="empl_email" class="col-md-4 col-form-label text-md-right">{{ __('E-Mail Address') }}:</label>
                            <div class="col-md-6">
                                <input id="empl_email" type="email" class="form-control @error('empl_email') is-invalid @enderror" name="empl_email" required>
                                @error('empl_email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>

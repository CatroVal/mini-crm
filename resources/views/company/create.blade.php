                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('company.save') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="comp-name" type="text" class="form-control @error('comp-name') is-invalid @enderror" name="comp-name" required>
                                @error('comp-name')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="comp-email" type="email" class="form-control @error('comp-email') is-invalid @enderror" name="comp-email">
                                @error('comp-email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
